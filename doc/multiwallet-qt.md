...
In order to support loading of multiple wallets in MERGE-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is MERGE.cpp.
...
Changes to MERGE.cpp
----------------------
MERGE.cpp is the entry point into MERGE-qt, and as such, will require some minor modifications to provide hooks for
